...
function Signup() {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="mx-auto w-full max-w-lg  rounded-lg ">
        ...
        <form onSubmit={handleSubmit(create)}>
          <div className="flex flex-col mt-7 gap-3 text-sm leading-5 max-md:max-w-full">
            ...
            <button
              type="submit"
              className="justify-center self-start px-4 py-2 mt-5 text-sm font-medium leading-6 text-white whitespace-nowrap rounded-lg bg-slate-900"
            >
              Create Account
            </button>
          </div>
