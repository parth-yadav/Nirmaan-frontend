    ...
    <div className="fixed inset-y-0 right-0 w-full max-w-xl z-50 flex justify-center">
      <div className="p-4 max-w-[600px] w-full h-full rounded-l-lg overflow-auto">
        <form className="flex flex-col text-sm rounded-none w-full">
          <section className="flex flex-col pt-8 w-full bg-white shadow-[-5px_0px_20px_rgba(0,0,0,0.25)] pb-8 rounded-lg">
            <div className="flex flex-col px-8 leading-none">
              <header className="flex flex-col w-full">
                ...
                <div className="flex flex-col mt-8 w-full">
                  ...
                  <div className="flex gap-2 items-start mt-1.5 text-slate-400">
                    <input
                      id="blogTitle"
                      type="text"
                      className="flex-1 py-2 px-3 bg-white rounded-lg border border-slate-300 w-full"
                ...
                <div className="flex flex-col mt-5 w-full">
                  ...
                  <textarea
                    id="blogDescription"
                    className="mt-1.5 px-3 pt-2 pb-14 bg-white rounded-lg border border-slate-300 w-full min-h-[80px] text-slate-400"
