...
function AddOptionButton() {
  return (
    <button className="flex gap-2 justify-center items-center self-start px-4 py-2 mt-8 font-medium leading-6 text-black bg-gray-300 rounded-lg">
      <img
        loading="lazy"
        ...
        alt=""
      />
      <span className="self-stretch my-auto">Add optionn</span>
    </button>
  );
}
