    ...
    <div className="flex flex-col mt-5 max-md:max-w-full mb-8">
      <div className="flex flex-col w-full max-md:max-w-full">
        <div className="flex flex-col w-full rounded-md max-md:max-w-full">
          ...
          <textarea
            id="description"
            className="gap-2.5 px-3 pt-2  mt-1.5 leading-none bg-white rounded-lg border border-solid border-slate-300 min-h-[80px] text-slate-400 w-[506px] max-md:max-w-full"
