...
function SaveChanges() {
  return (
    <button className="flex gap-2 justify-center items-center self-start px-4 py-2 mt-11 text-sm font-medium leading-6 text-white rounded-lg bg-slate-800 max-md:mt-10">
      <img
        loading="lazy"
