...
function Header() {
  return (
    ...
    //   <nav className="flex flex-wrap items-center p-1.5 mt-8 w-full text-sm font-medium leading-none rounded-lg bg-slate-100 max-md:mr-1.5 max-md:max-w-full">
    //     <button className="flex-1 flex items-center justify-center gap-2.5 px-3 py-1.5 bg-white rounded text-slate-900">
    //       Exam schema
    //     </button>
    //     <button className="flex-1 flex items-center justify-center gap-2.5 px-3 py-1.5 rounded  text-red-700">
    //       Marketplace info
    //     </button>
