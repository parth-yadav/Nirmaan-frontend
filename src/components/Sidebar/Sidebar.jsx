...
// // ... (keep the sidebarItems and SidebarItem component as they are)
// function SLogoutBtn() {
//     const dispatch = useDispatch()
//     const logoutHandler = () => {
//         authService.logout().then(() => {
...
// function Sidebar({ isMobile, isOpen, onToggle }) {
//   const dispatch = useDispatch()
//   const logoutHandler = () => {
//     authService.logout().then(() => {
//       dispatch(logout())
...
//   return (
//     <aside
//       className={`fixed top-0 left-0 h-screen w-64 bg-white dark:bg-black border-r border-gray-300 transform ${isMobile ? (isOpen ? "translate-x-0" : "-translate-x-full") : "translate-x-0"} transition-transform duration-300 ease-in-out overflow-hidden`}
//     >
//       <div className="flex flex-col h-full">
//         <nav className="flex-grow overflow-y-auto px-2.5 pt-6 pb-3.5">
...
//           <hr className="shrink-0 h-px bg-gray-300 border border-gray-300 border-solid" />
...
//               className="flex justify-center items-center px-2 w-8 h-8 bg-white rounded-md border border-gray-300 border-solid"
//             >
//               <img
//                 loading="lazy"
//                 src="https://cdn.builder.io/api/v1/image/assets/TEMP/1a9859a78eb99bcbd27fe6539c74fff6970a216032b996c9f5005f49abce9fcf?apiKey=8a82faa9db93454483a68c973b38c7b0&"
...
function Sidebar({ isMobile, isOpen, onToggle }) {
  ...
  return (
    <aside
      ...
      } left-0 h-screen w-64 bg-white border  dark:bg-gray-800 transform ${
        isMobile
          ? isOpen
            ? "translate-x-0"
            : "-translate-x-full"
